...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'ui.stop': { en: 'Stop', zh: '停止' },
  'ui.send': { en: 'Send', zh: '发送' },
  'ui.info': { en: 'Info', zh: '信息' },
  'ui.projects': { en: 'Projects', zh: '项目' },
  'ui.disconnect': { en: 'Disconnect', zh: '断开连接' },
  'ui.create': { en: 'Create', zh: '创建' },
  'ui.no_projects': { en: 'No projects yet.\nCreate a new session to get started.', zh: '暂无项目。\n创建新会话以开始。' },
  'ui.checkout': { en: 'checkout', zh: '检出' },
  'ui.head': { en: 'head', zh: '当前' },
  'ui.command_picker_title': { en: 'Commands', zh: '命令' },
  'ui.command_picker_close': { en: 'close', zh: '关闭' },
  // ===== 错误提示 =====
